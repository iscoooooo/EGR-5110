...
% Define a color for equation references
\definecolor{eqrefcolor}{RGB}{255,255,255} % white

% Redefine the format for equation references
\renewcommand{\theequation}{\textcolor{eqrefcolor}{\arabic{equation}}}
...
\input{sections/LagrangePoints.tex}

% Subsections of Lagrange Points section
\input{subsections/CollinearSolutions.tex}
\input{subsections/NonCollinearSolutions.tex}
